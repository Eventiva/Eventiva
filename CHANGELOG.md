...
## [0.1.6](https://github.com/Eventiva/Eventiva/compare/eventiva-v0.1.5...eventiva-v0.1.6) (2024-03-28)


### Features

* **aspect-template.ts:** add AspectTemplate class to generate files for creating an aspect ([a4e8339](https://github.com/Eventiva/Eventiva/commit/a4e8339cfd6aeb85da19b8982c1f611d5420b771))
* **base:** add base.docs.mdx file with documentation for the Base entity ([da59216](https://github.com/Eventiva/Eventiva/commit/da59216c95cee906dbbb2e3a51dc3ccbd366c1f3))
* **base:** add base.spec.ts file with a test for the Base.from() method ([da59216](https://github.com/Eventiva/Eventiva/commit/da59216c95cee906dbbb2e3a51dc3ccbd366c1f3))
* **base:** add base.ts file with implementation of the Base class ([da59216](https://github.com/Eventiva/Eventiva/commit/da59216c95cee906dbbb2e3a51dc3ccbd366c1f3))
* **base:** add index.ts file to export the Base class ([da59216](https://github.com/Eventiva/Eventiva/commit/da59216c95cee906dbbb2e3a51dc3ccbd366c1f3))
* **column:** add Column entity and related files ([402597b](https://github.com/Eventiva/Eventiva/commit/402597b1c272b15ee04d3ec49ce9c9b62c358ae7))
* **config:** add .mocharc.js file to configure Mocha test runner ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **config:** add mocha-babel-config.js file to configure Babel for Mocha tests ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **config:** add tsconfig.json file to configure TypeScript compiler options ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **config:** update eslintrc.js to extend @bitdev/react.eslint.eslint-config-bit-react ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **config:** update jest.config.js to override Jest config and exclude specific packages from transpiling ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **config:** update prettier.config.js to use @bitdev/react.react-env prettier config ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **customer-support:** add CustomerSupport aspect to Atlassian integrations ([e212047](https://github.com/Eventiva/Eventiva/commit/e2120478aef483fbfa9db43ca87b96aafe6cafb3))
* database v0 ([4cbc035](https://github.com/Eventiva/Eventiva/commit/4cbc035f8e2b07f2326bfb29fd436d503fd23094))
* **database:** add getter functions for entityManager and isInitialised properties in DatabaseNode ([d09a199](https://github.com/Eventiva/Eventiva/commit/d09a199031a0c9995536e125a33a49e96971380b))
* **database:** add support for EntityManager and initialise MikroORM in DatabaseNode constructor ([d09a199](https://github.com/Eventiva/Eventiva/commit/d09a199031a0c9995536e125a33a49e96971380b))
* **database:** update database.node.runtime.ts to use MikroORM instead of Prisma for better ORM support ([d09a199](https://github.com/Eventiva/Eventiva/commit/d09a199031a0c9995536e125a33a49e96971380b))
* **database:** update defaultConfig in DatabaseNode to include necessary configuration options for MikroORM ([d09a199](https://github.com/Eventiva/Eventiva/commit/d09a199031a0c9995536e125a33a49e96971380b))
* **database:** update index.ts to export DefaultArgs type from @prisma/client/runtime/library.js ([d09a199](https://github.com/Eventiva/Eventiva/commit/d09a199031a0c9995536e125a33a49e96971380b))
* **discord-runtime:** add Discord runtime options file to provide type for DiscordRuntimeOptions ([81f36cc](https://github.com/Eventiva/Eventiva/commit/81f36ccae1581adb3bceaab47d53515781f55812))
* **discord:** add Discord runtime implementation ([cbc7eef](https://github.com/Eventiva/Eventiva/commit/cbc7eef03fd10514e873d6fc18c268fa69fe0c52))
...
* **document:** add Document entity and related files ([a609a45](https://github.com/Eventiva/Eventiva/commit/a609a45fff35a32a204baa8002a2b109cc330346))
* **entity-template.ts:** add EntityTemplate class to generate component files for creating entities ([69c80e8](https://github.com/Eventiva/Eventiva/commit/69c80e8829a3af73e909cde25bc2726426151d4d))
* **generator:** add support for harmonyEnvId option in Generator function ([83721de](https://github.com/Eventiva/Eventiva/commit/83721de9c428a7e8eaacc19326425e66005e7801))
* **harmony-templates-options.ts:** add harmonyEnvId property to HarmonyTemplatesOptions to specify the harmony env to apply on the templates ([d4b7eda](https://github.com/Eventiva/Eventiva/commit/d4b7eda9e7defb2ea8e69aeeb979e09c25600cce))
* **mikro.bit-env.ts:** create Mikro class that extends NodeEnv and add build method ([a51f165](https://github.com/Eventiva/Eventiva/commit/a51f1655b1fc2f2f636c82c445fa0e8c96c34529))
* **mikro.docs.mdx:** add documentation for Mikro ORM environment ([a51f165](https://github.com/Eventiva/Eventiva/commit/a51f1655b1fc2f2f636c82c445fa0e8c96c34529))
* **mikro.env.jsonc:** add Mikro ORM environment configuration file ([a51f165](https://github.com/Eventiva/Eventiva/commit/a51f1655b1fc2f2f636c82c445fa0e8c96c34529))
* **mikro.index.ts:** add export for Mikro class and default export ([a51f165](https://github.com/Eventiva/Eventiva/commit/a51f1655b1fc2f2f636c82c445fa0e8c96c34529))
* **mikro.node.runtime.ts:** add MikroNode class to handle MikroORM initialization and provide EntityManager instance ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **mikro.node.spec.ts:** add test to retrieve MikroNode aspect ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **model.zmodel:** make the 'deletedAt' field nullable in the 'Base' and 'AnonymousBase' models to allow soft deletion ([da59216](https://github.com/Eventiva/Eventiva/commit/da59216c95cee906dbbb2e3a51dc3ccbd366c1f3))
* **mounter.tsx:** add new file mounter.tsx to provide a mounter component for injecting and wrapping component previews ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for ConfigWriterList to configure TypeScriptConfigWriter, EslintConfigWriter, and PrettierConfigWriter ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for ESLintLinter to enforce coding standards using ESLint ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for generating Node environment templates, including NodeEnvTemplate and NodeModuleTemplate ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for PackageGenerator to configure and control the packaging process of components ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for Pipeline to define build pipeline for components, including TypescriptTask and VitestTask ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for PrettierFormatter to automate code styling using Prettier ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for ReactPreview to enable previewing React components ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for TypeScriptCompiler to compile TypeScript files with esm option enabled ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for TypeScriptExtractor to extract schema information from TypeScript files ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **node.bit-env.ts:** add support for VitestTester to run tests using Vite test runner ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **orm/mikro:** add Mikro aspect to the project ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability of the platform ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability of the platform. The MikroAspect class is used to create an instance of the Mikro aspect. It takes an object as a parameter with an 'id' property specifying the ID of the aspect. ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability of the platform. The MikroAspect class is used to create an instance of the Mikro aspect. It takes an object as a parameter with an 'id' property specifying the ID of the aspect. The MikroAspect class is exported as the default export of the module. ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability of the platform. The MikroAspect class is used to create an instance of the Mikro aspect. It takes an object as a parameter with an 'id' property specifying the ID of the aspect. The MikroAspect class is exported as the default export of the module. The MikroAspect class is also exported as a named export. ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to enable composition and extendability of the platform. The MikroAspect class is used to create an instance of the Mikro aspect. It takes an object as a parameter with an 'id' property specifying the ID of the aspect. The MikroAspect class is exported as the default export of the module. The MikroAspect class is also exported as a named export. The MikroAspect class is used to create an instance of the Mikro aspect. It takes an object as a parameter with an 'id' property specifying the ID of the aspect. The MikroAspect class is exported as the default export of the module. The MikroAspect class is also exported as a named export. The MikroAspect class is used to create an instance of the Mikro aspect. ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to maintain Mikro across the platform ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **orm/mikro:** add Mikro aspect to the project to provide a UI and API ([5450e1c](https://github.com/Eventiva/Eventiva/commit/5450e1c9eb4101a66bdbaa41ef091a817ec23c3d))
* **ping:** add Ping aspect for Discord bot commands ([c5861c4](https://github.com/Eventiva/Eventiva/commit/c5861c4af25b19ec16f5ad8aa05e04f4d1d2a213))
* **pkl:** add new script pkl ([627941a](https://github.com/Eventiva/Eventiva/commit/627941aea6f4204418128db7dfca023b143db8f9))
* **prisma:** add Prisma aspect and related files ([00f78e2](https://github.com/Eventiva/Eventiva/commit/00f78e28b9268116341f99dfa537aa93d8fe115d))
* **prisma:** add Prisma environment for ORM development ([19b02e0](https://github.com/Eventiva/Eventiva/commit/19b02e066fe6d6f45dc93ad4619efaaf6a659951))
* **segment.node.runtime.ts:** add implementation for SegmentNode class with methods for registering instances, retrieving instances, and listing instances ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment.node.spec.ts:** add test case for retrieving the SegmentNode aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add index.ts file for Segment aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add instance.ts file for Segment aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add Segment aspect to the project ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add segment-config.ts file for Segment aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add segment.aspect.ts file for Segment aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
* **segment:** add segment.docs.mdx file for Segment aspect ([868d73e](https://github.com/Eventiva/Eventiva/commit/868d73e4ee2bc2681666ef07f4bdd45b07a12c2b))
...
* **support:** add CHANGELOG.md file with initial version 0.1.0 ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add index.html file for support platform ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add index.ts file for support platform ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add support platform for Discord ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add support.bit-app.ts file for support platform ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add support.docs.mdx file for support platform ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **support:** add version.txt file with initial version 0.1.0 ([922fa52](https://github.com/Eventiva/Eventiva/commit/922fa524f8d59d36df498a4918796d6c1e0fb13a))
* **symphony-platform:** add symphony platform template ([1b6e170](https://github.com/Eventiva/Eventiva/commit/1b6e170474ec87ff86a86ef9740bc17ba42d90f0))
* **symphony-templates-options.ts:** add symphonyEnvId property to SymphonyTemplatesOptions type to allow specifying Symphony environment ID ([85e1851](https://github.com/Eventiva/Eventiva/commit/85e18512bdb33f78a6cd2576419587925dab09ec))
* **symphony-templates.ts:** add SymphonyTemplates function to create Symphony templates with provided options ([bab905b](https://github.com/Eventiva/Eventiva/commit/bab905b3b970b07b97955eb1a89862a86341c498))
* **symphony-templates.ts:** pass symphonyEnvId option to SymphonyPlatformTemplate.from() to include Symphony environment ID in templates ([85e1851](https://github.com/Eventiva/Eventiva/commit/85e18512bdb33f78a6cd2576419587925dab09ec))
* **vitest.config.mjs:** add vitest.config.mjs file to configure Vite for the project ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
...
* **node.bit-env.ts:** uninstall NativeCompileCache to disable v8-caching as it breaks ESM loaders ([d531a70](https://github.com/Eventiva/Eventiva/commit/d531a70d13fa91e4204b71512b7de44c1202c46b))
* **segment/instance.ts:** change InstanceSlot type from `SlotRegistry&lt;Instance<true&gt;>` to `SlotRegistry<Instance<true>[]>` to correctly represent an array of instances ([30ddd44](https://github.com/Eventiva/Eventiva/commit/30ddd44f118cbbfa981538f9cce7a7903e46d7a0))
