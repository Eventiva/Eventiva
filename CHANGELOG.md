...
## [0.1.2](https://github.com/Eventiva/Eventiva/compare/eventiva-v0.1.1...eventiva-v0.1.2) (2024-02-13)


### Features

* **management-changelog.yml:** add support for release branches in the on event to trigger the workflow for release branches ([60ebed3](https://github.com/Eventiva/Eventiva/commit/60ebed37ce540b8c679b766228355740c8564da5))
* **management-changelog.yml:** remove unnecessary logic for determining target-branch value and use the branch name directly ([27c7845](https://github.com/Eventiva/Eventiva/commit/27c78459558f3d33342a56afa33b6b4704d0b1c9))
* **release-develop-config.json:** add pull request header to indicate availability of new pre-release ([0015fe5](https://github.com/Eventiva/Eventiva/commit/0015fe5fb90f986686e1cd29494b244b5ecab3fa))
* **release-main-config.json:** add pull request header to indicate availability of new release ([0015fe5](https://github.com/Eventiva/Eventiva/commit/0015fe5fb90f986686e1cd29494b244b5ecab3fa))
* **release-please:** add release-please configuration files ([6ee24ef](https://github.com/Eventiva/Eventiva/commit/6ee24efcfed3d9807a1fc92ca620db38005c84f3))
...
* **management-changelog.yml:** fix config-file value to be dynamically determined based on the branch name ([27c7845](https://github.com/Eventiva/Eventiva/commit/27c78459558f3d33342a56afa33b6b4704d0b1c9))
* **management-changelog.yml:** fix the config-file path in the release job to use the correct config file based on the branch name ([60ebed3](https://github.com/Eventiva/Eventiva/commit/60ebed37ce540b8c679b766228355740c8564da5))
