...
export declare const DuplicateColumnError: (tableName: string, columnName: string, extensionId: string) => DuplicateColumnError;
//# sourceMappingURL=duplicate-column-error.d.ts.map