...
import { DuplicateColumnError as MakeDuplicateColumnError } from "./duplicate-column-error.js";
import { FinalTableStore } from "./final-table-store.js";
import { SchemaFinalizer } from "./schema-finalizer.js";
import { withSpanAndLog } from "../observability/helpers.js";
export const TableColumnRegistry = Context.GenericTag("@eventiva/core/TableColumnRegistry");
function runFinalization(stateRef, deferred, finalizer, store) {
    return Effect.gen(function* () {
        ...
        for (const tableName of tableNames) {
            ...
            yield* finalizer
                ...
                .pipe(Effect.flatMap((table) => store.setTable(tableName, table)));
        }
...
export const TableColumnRegistryLive = Layer.effect(TableColumnRegistry, Effect.gen(function* () {
    ...
    const registry = {
        registerTableColumns: (tableName, extensionId, columns, extraConfig) => Effect.gen(function* () {
            ...
            const extraConfigs = extraConfig != null
        ...
        setExpectedReadyCount: (n) => Effect.gen(function* () {
        ...
        markReady: (extensionId) => Effect.gen(function* () {
