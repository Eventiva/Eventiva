...
export interface WorkflowRegistry {
    readonly register: <Payload, Result, Error, R>(workflow: Workflow<string, Payload, Result, Error>, executeFn: (options: WorkflowExecuteOptions<Payload>) => Effect.Effect<Result, Error, R>) => Effect.Effect<void, never, R>;
    readonly execute: <Payload, Result, Error>(workflow: Workflow<string, Payload, Result, Error>, options: WorkflowExecuteOptions<Payload>) => Effect.Effect<Result, Error>;
}
