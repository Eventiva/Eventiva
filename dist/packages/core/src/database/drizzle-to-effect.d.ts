 ...
 */
export type Columns<TTable extends Drizzle.Table> = TTable['_']['columns'] extends infer TColumns extends Record<string, Drizzle.Column<any>> ? TColumns : never;
/**
 ...
 */
export type PropertySignatureEncoded<T> = T extends Schema.PropertySignature<any, any, any, any, infer From, any, any> ? From : never;
/**
 ...
 */
export type PropertySignatureType<T> = T extends Schema.PropertySignature<any, infer To, any, any, any, any, any> ? To : never;
/**
 ...
 */
export type InsertRefineArg<TTable extends Drizzle.Table, Col extends keyof Columns<TTable>> = Schema.Schema<any, any, any> | ((s: {
    [S in keyof InsertColumnPropertySignatures<TTable>]: InsertColumnPropertySignatures<TTable>[S] extends Schema.PropertySignature<any, any, any, any, any, any, any> ? Schema.Schema<Exclude<PropertySignatureEncoded<InsertColumnPropertySignatures<TTable>[S]>, undefined | null>, Exclude<PropertySignatureType<InsertColumnPropertySignatures<TTable>[S]>, undefined | null>> : InsertColumnPropertySignatures<TTable>[S];
}) => InsertColumnPropertySignatures<TTable>[Col] extends Schema.PropertySignature<any, any, any, any, any, any, any> ? Schema.Schema<Exclude<PropertySignatureEncoded<InsertColumnPropertySignatures<TTable>[Col]>, undefined | null>, any> : Schema.Schema<Exclude<Schema.Schema.Encoded<InsertColumnPropertySignatures<TTable>[Col]>, undefined | null>, any>);
/**
 ...
 */
export type SelectRefineArg<TTable extends Drizzle.Table, Col extends keyof Columns<TTable>> = Schema.Schema<any, any, any> | ((s: {
    [S in keyof InsertColumnPropertySignatures<TTable>]: InsertColumnPropertySignatures<TTable>[S] extends Schema.PropertySignature<any, any, any, any, any, any, any> ? Schema.Schema<Exclude<PropertySignatureEncoded<InsertColumnPropertySignatures<TTable>[S]>, undefined | null>, Exclude<PropertySignatureType<InsertColumnPropertySignatures<TTable>[S]>, undefined | null>> : InsertColumnPropertySignatures<TTable>[S];
}) => InsertColumnPropertySignatures<TTable>[Col] extends Schema.PropertySignature<any, any, any, any, any, any, any> ? Schema.Schema<Exclude<PropertySignatureEncoded<InsertColumnPropertySignatures<TTable>[Col]>, undefined | null>, any> : Schema.Schema<Exclude<Schema.Schema.Encoded<InsertColumnPropertySignatures<TTable>[Col]>, undefined | null>, any>);
/**
 ...
 */
export declare const literalSchema: Schema.Union<[typeof Schema.String, typeof Schema.Number, typeof Schema.Boolean, typeof Schema.Null]>;
/**
...
export type JsonType = string | number | boolean | {
    [key: string]: JsonType;
} | JsonType[] | readonly JsonType[] | null;
/**
 ...
 */
export declare const Json: Schema.suspend<JsonType, JsonType, never>;
/**
 ...
 */
export type GetSchemaForType<TColumn extends Drizzle.Column> = TColumn['_']['dataType'] extends infer TDataType ? TDataType extends 'custom' ? Schema.Schema<any> : TDataType extends 'json' ? Schema.Schema<JsonType> : TColumn extends {
    enumValues: [string, ...string[]];
} ? Drizzle.Equal<TColumn['enumValues'], [string, ...string[]]> extends true ? Schema.Schema<string> : Schema.Schema<TColumn['enumValues'][number]> : TDataType extends 'array' ? Schema.Schema<null | readonly Drizzle.Assume<TColumn['_'], {
    baseColumn: Drizzle.Column;
}>['baseColumn']['_']['data'][]> : TDataType extends 'bigint' ? Schema.Schema<bigint> : TDataType extends 'number' ? Schema.Schema<number> : TDataType extends 'string' ? Schema.Schema<string> : TDataType extends 'boolean' ? Schema.Schema<boolean> : TDataType extends 'date' ? Schema.Union<[typeof Schema.DateFromString, typeof Schema.ValidDateFromSelf]> : Schema.Schema<any> : never;
/**
 ...
 */
export type MapInsertColumnToPropertySignature<TColumn extends Drizzle.Column> = TColumn['_']['notNull'] extends false ? Schema.PropertySignature<'?:', Schema.Schema.Type<GetSchemaForType<TColumn>> | undefined | null, TColumn['_']['name'], '?:', Schema.Schema.Encoded<GetSchemaForType<TColumn>> | undefined | null, false, never> : TColumn['_']['hasDefault'] extends true ? Schema.PropertySignature<'?:', Schema.Schema.Type<GetSchemaForType<TColumn>> | undefined, TColumn['_']['name'], '?:', Schema.Schema.Encoded<GetSchemaForType<TColumn>> | undefined, true, never> : GetSchemaForType<TColumn>;
/**
 ...
 */
export type MapSelectColumnToPropertySignature<TColumn extends Drizzle.Column> = TColumn['_']['notNull'] extends false ? Schema.Schema<Schema.Schema.Type<GetSchemaForType<TColumn>> | null> : GetSchemaForType<TColumn>;
/**
 ...
 */
export type PropertySignatureReplaceType<S, ReplaceWith> = S extends Schema.PropertySignature<infer TokenType, any, infer Name, infer TokenEncoded, infer Encoded, infer HasDefault, infer R> ? Schema.PropertySignature<TokenType, ReplaceWith, Name, TokenEncoded, Encoded, HasDefault, R> : never;
/**
 ...
 */
export type CarryOverNull<From, To> = null extends From ? To | null : To;
/**
 ...
 */
export type CarryOverUndefined<From, To> = undefined extends From ? To | undefined : To;
/**
 ...
 */
export type CarryOverOptionality<From, To> = CarryOverNull<From, CarryOverUndefined<From, To>>;
/**
 ...
 */
export type BuildInsertSchema<TTable extends Drizzle.Table, TRefine extends InsertRefine<TTable> | {} = {}> = Schema.Struct<InsertColumnPropertySignatures<TTable> & {
    [K in keyof TRefine & string]: InsertColumnPropertySignatures<TTable>[K] extends Schema.PropertySignature<any, any, any, any, any, any> ? TRefine[K] extends Schema.Schema<any, any, any> ? Schema.Schema<CarryOverOptionality<PropertySignatureType<InsertColumnPropertySignatures<TTable>[K]>, Schema.Schema.Type<TRefine[K]>>> : TRefine[K] extends (...a: any[]) => any ? PropertySignatureReplaceType<InsertColumnPropertySignatures<TTable>[K], CarryOverOptionality<PropertySignatureType<InsertColumnPropertySignatures<TTable>[K]>, Schema.Schema.Type<ReturnType<TRefine[K]>>>> : never : TRefine[K];
}>;
/**
 ...
 */
export type BuildSelectSchema<TTable extends Drizzle.Table, TRefine extends InsertRefine<TTable> | {} = {}> = Schema.Struct<{
    [K in keyof SelectColumnPropertySignatures<TTable>]: SelectColumnPropertySignatures<TTable>[K];
} & {
    [K in keyof TRefine & string]: SelectColumnPropertySignatures<TTable>[K] extends Schema.PropertySignature<any, any, any, any, any, any> ? TRefine[K] extends Schema.Schema<any, any, any> ? Schema.Schema<CarryOverOptionality<PropertySignatureType<SelectColumnPropertySignatures<TTable>[K]>, Schema.Schema.Type<TRefine[K]>>> : TRefine[K] extends (...a: any[]) => any ? PropertySignatureReplaceType<SelectColumnPropertySignatures<TTable>[K], CarryOverOptionality<PropertySignatureType<SelectColumnPropertySignatures<TTable>[K]>, Schema.Schema.Type<ReturnType<TRefine[K]>>>> : never : TRefine[K];
}>;
/**
 ...
 */
export declare function createInsertSchema<TTable extends Drizzle.Table, TRefine extends InsertRefine<TTable>>(table: TTable, refine?: {
    [K in keyof TRefine]: K extends keyof TTable['_']['columns'] ? TRefine[K] : Drizzle.DrizzleTypeError<`Column '${K & string}' does not exist in table '${TTable['_']['name']}'`>;
 ...
 */
export declare function createSelectSchema<TTable extends Drizzle.Table, TRefine extends SelectRefine<TTable>>(table: TTable, refine?: {
    [K in keyof TRefine]: K extends keyof TTable['_']['columns'] ? TRefine[K] : Drizzle.DrizzleTypeError<`Column '${K & string}' does not exist in table '${TTable['_']['name']}'`>;
 ...
 */
export declare function mapColumnToSchema(column: Drizzle.Column): Schema.Schema<any, any>;
/**
 ...
 */
export declare function isWithEnum(column: Drizzle.Column): column is typeof column & {
    enumValues: [string, ...string[]];
};
//# sourceMappingURL=drizzle-to-effect.d.ts.map