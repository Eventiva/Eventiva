 ...
 */
export declare function defineModel<Name extends string, A, I = A, R = never>(name: Name, schema: Schema.Schema<A, I, R>): Model<Name, A>;
/**
 ...
 */
export declare function extendModel<Name extends string, BaseA, ExtraFields extends Record<string, Schema.Schema.All>>(baseModel: Model<Name, BaseA>, extraSchema: Schema.Schema<ExtraFields>): Schema.Schema<BaseA & Schema.Schema.Type<ExtraFields>>;
