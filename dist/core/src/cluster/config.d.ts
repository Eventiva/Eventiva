 ...
 */
export declare const clusterLayerDefault: Layer.Layer<never, never, never>;
/**
 ...
 */
export declare function makeSingleRunnerLayer(shardingConfigOverrides?: Partial<ShardingConfig.ShardingConfig['Type']>): ReturnType<typeof SingleRunner.layer>;
/**
 ...
 */
export declare function makeClusterLayer(mode: ClusterMode): Layer.Layer<never, never, never> | ReturnType<typeof makeSingleRunnerLayer>;
/**
 ...
 * ```
 */
export declare const globalClusterLayer: import("effect/Effect").Effect<Layer.Layer<never, never, never>, never, import("effect/Scope").Scope>;
/**
 ...
 * ```
 */
export declare const memoizeLayer: <RIn, E, ROut>(self: Layer.Layer<ROut, E, RIn>) => import("effect/Effect").Effect<Layer.Layer<ROut, E, RIn>, never, import("effect/Scope").Scope>;
