 ...
 */
export declare const ClusterWorkflowEngineLayer: Layer.Layer<import("@effect/workflow/WorkflowEngine").WorkflowEngine, never, import("@effect/cluster/Sharding").Sharding | import("@effect/cluster/MessageStorage").MessageStorage>;
