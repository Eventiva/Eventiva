...
/**
 * @deprecated Use {@link ObservabilityStackLive}. Kept as an alias for existing imports.
 */
export const ObservabilityLive: Layer.Layer<Resource.Resource, ConfigError, never> = ObservabilityStackLive;
