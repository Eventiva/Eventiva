 ...
 * Project: Eventiva
 * File: file-schema.ts
 * Last Modified: 03/09/2024, 21:42
 *
...
export const fileBrand = Symbol( 'File' )
...
const variants = {
    buffer: () => bufferSchema.brand( fileBrand as symbol ),
    string: () => z.string().brand( fileBrand as symbol ),
    binary: () => bufferSchema.or( z.string() ).brand( fileBrand as symbol ),
    base64: () =>
        z
            .string()
            .base64()
            .brand( fileBrand as symbol )
}
