---
description: 'A plugable Development aspect. Can be used to provider a UI and API.'
labels: ['aspect', 'composition', 'extendability']
---

A plugable Development aspect. Used to maintain Development across the platform.
