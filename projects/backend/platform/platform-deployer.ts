...
import { GatewayServer } from '@bitdev/symphony.backends.gateway-server'
import { ApplicationDeployment } from '@teambit/application'
...
export interface PlatformDeployer {
     ...
     * a deploy function.
     */
    deploy: ( context: PlatformDeployerContext ) => Promise<ApplicationDeployment>;
}
...
export type ServerContext = {
    ...
    /**
     * specific args e.g {execFile} run service people
     */
...
export type PlatformDeployerContext = {
    /** name of the app */
    appName: string;
     ...
     * runtimes context
     */
    runtimesContext: RuntimeContext[];
    ...
    /**
     * insecure deploy, if true, will deploy app without cert, `http://wyan.com`
     */
    inSecure?: boolean;
};

export type PlatformDeployerSlot = SlotRegistry<PlatformDeployer[]>;
