...
import { GraphqlAspect } from '@eventiva/backend.graphql'
import { PlatformAspect } from '@eventiva/backend.platform'
import { RestAspect } from '@eventiva/backend.rest'
 ...
 */
export const Default = HarmonyPlatform.from( {
    name: 'default',
