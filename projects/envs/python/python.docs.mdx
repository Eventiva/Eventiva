...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "eventiva.workflows/frappe/python"
    ]
  }
}
```
...
```
bit env set my-component eventiva.workflows/frappe/python
```
...
```
bit new node my-workspace --aspect eventiva.workflows/frappe/python
```
