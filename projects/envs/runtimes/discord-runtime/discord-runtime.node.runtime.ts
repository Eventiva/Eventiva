 ...
 * File: discord-runtime.node.runtime.ts
 * Path: /projects/envs/runtimes/discord-runtime/discord-runtime.node.runtime.ts
...
export class DiscordRuntimeNode {
  static async provider() {
    return new DiscordRuntimeNode();
  }
}

export default DiscordRuntimeNode;
