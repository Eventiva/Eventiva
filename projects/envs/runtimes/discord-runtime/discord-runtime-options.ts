 ...
 * Path: /projects/envs/runtimes/discord-runtime/discord-runtime-options.ts
...
import type { NodeServerOptions } from "@bitdev/node.node-server";

/**
 * Type representing Discord runtime options. It is an Omit type that excludes the 'mainPath' and 'name' properties from the NodeServerOptions type.
