 ...
 * Path: /projects/envs/node/node.bit-env.ts
...
import { NodeModuleTemplate, NodeAppTemplate, NodeEnvTemplate } from '@bitdev/node.generators.node-templates'
 ...
 * @extends {HarmonyEnv}
 */
export class Node extends SymphonyEnv {
