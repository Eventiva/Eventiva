 ...
 * Path: /projects/envs/node/config/webpack.config.ts
...
/**
 * A function that takes a WebpackConfigMutator as an argument and returns the same WebpackConfigMutator without modification.
 *
 * @param {WebpackConfigMutator} configMutator A function that takes a WebpackConfigMutator as a parameter and returns the same WebpackConfigMutator
 * @returns {WebpackConfigMutator} A function that takes a WebpackConfigMutator and returns the same WebpackConfigMutator without performing any operations on it.
 */
