...
* File: runtime-options.ts
* Path: \projects\workflows\bit\runtime-options\runtime-options.ts
...
/**
 * The options for configuring the runtime.
 * Each property represents a specific aspect of the runtime configuration.
 * @author Jonathan Stevens (@TGTGamer)
 *
 * @export
 */
