 ...
 * File: index.ts
 * Path: \projects\workflows\generators\discord\bot\index.ts
...
export { DiscordBotRouteTemplate } from './discord-bot-route/app-template';
export { DiscordBotTemplate } from './discord-bot/app-template';