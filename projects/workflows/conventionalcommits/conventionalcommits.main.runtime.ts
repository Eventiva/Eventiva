 ...
 * Last Modified: 3/23/24, 11:58 PM
 * -----
...
import { ConventionalcommitsAspect } from './conventionalcommits.aspect'
import { mainPrompt } from './prompts/main.prompt'

export class ConventionalcommitsMain {
    ...
    prompts = {
        ...
        main: mainPrompt.bind( this )
    }

    static async provider (
        [ cli ]: [ CLIMain ]
    ) {
        const conventional = new ConventionalcommitsMain()
...
ConventionalcommitsAspect.addRuntime( ConventionalcommitsMain )

export default ConventionalcommitsMain
