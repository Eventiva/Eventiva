...
The following functions have been refactored to improve readability and maintainability.
...
This project utilises the [Smartcloud Project](https://github.com/Eventiva/smartcloud) to automate our workflow.
