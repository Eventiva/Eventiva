...
"""Thank you for your interest in contributing. We appreciate your contributions to the Eventiva repository. To get started, use one of the supported platforms, such as [VSCode](https://code.visualstudio.com/docs/remote/containers) or [Github Codespaces](https://github.com/features/codespaces), which are already configured and ready to go. You can also learn more about our development workflow and templates in the [Smartcloud Project documentation](https://github.com/Eventiva/smartcloud)."""
