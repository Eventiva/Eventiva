...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "eventiva.workflows/frappe/python-env"
    ]
  }
}
```
...
```
bit env set my-component eventiva.workflows/frappe/python-env
```
...
```
bit new node my-workspace --aspect eventiva.workflows/frappe/python-env
```
