...
* Path: \projects\central\aspects\segment\segment.node.runtime.ts
...
export class SegmentNode {
  ...
  /**
   * Creates a new SegmentNode instance with the provided configuration. Throws an error if the SegmentConfig does not have a writeKey defined. Returns the created SegmentNode instance.
   * @author Jonathan Stevens (@TGTGamer)
   *
   * @static
   * @async
   * @param param0 An empty array
   * @param config Segment configuration object
   * @param param1 An array containing an instance slot
   * @param param1.instanceSlot
   * @returns A static asynchronous function that returns a new SegmentNode instance based on the provided config and instanceSlot. It throws an error if the writeKey is missing in the config.
   */
