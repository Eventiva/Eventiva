...
* File: instance.ts
* Path: \projects\central\aspects\segment\instance.ts
...
export interface Instance<bool extends Boolean> extends AnalyticsSettings {
  /**
   ...
   * @author Jonathan Stevens (@TGTGamer)
   */
  analytics: bool extends false ? null : Analytics;
}
