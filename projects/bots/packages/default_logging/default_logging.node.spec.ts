...
* Path: \projects\bots\packages\default_logging\default_logging.node.spec.ts
...
it('should retrieve the aspect', async () => {
  const default_logging = await loadAspect<DefaultLoggingNode>(DefaultLoggingAspect, {
    runtime: 'node',
  });
