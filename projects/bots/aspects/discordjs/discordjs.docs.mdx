---
description: 'A plugable Discordjs aspect. Can be used to provider a UI and API.'
labels: ['aspect', 'composition', 'extendability']
---

A plugable Discordjs aspect. Used to maintain Discordjs across the platform.
