...
* Path: \projects\bots\aspects\harmony-bot-generators\aspect\aspect-template.ts
...
import { HarmonyBotGeneratorsOptions } from "../harmony-bot-generators-options.js";
 ...
 * - `options`: The options for the HarmonyBot generators.
...
export class AspectTemplate implements ComponentTemplate {
   ...
   * @param [name='aspect']
   * @param [description='create an aspect, and compose to your harmony platform']
   * @param [hidden=false]
   * @param [env]
   * @param [options={}]
  ...
  /**
   * Creates a new instance of AspectTemplate using the provided options. If no options are provided, default options will be used.
   * @author Jonathan Stevens (@TGTGamer)
   *
   * @static
   * @param [options={}]
   * @returns Creates an instance of AspectTemplate with the provided options.
   */
