...
* File: mount-server.tsx
* Path: \projects\bots\aspects\support-platform\mount-server.tsx
...
import {
  SupportPlatformApp,
  SupportPlatformAppProps,
} from './support-platform-app.js'; 

export async function mountServer(
  path: string,
  cookie: string,
  options: SupportPlatformAppProps
) {
