...
* File: backend.ts
* Path: \projects\bots\aspects\support-platform\backend.ts
...
export type BackendServer = {
   ...
   */
  run: (context: SupportPlatformContext) => Promise<ApplicationInstance>;
};
 ...
 */
export type SupportPlatformContext = {
  /**
   * port to use.
   */
  port?: number;
...
/**
 * Represents a backend slot, which is a registry of backend servers.
