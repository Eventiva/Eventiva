---
description: 'A plugable SupportPlatform aspect. Can be used to provider a UI and API.'
labels: ['aspect', 'composition', 'extendability']
---

A plugable SupportPlatform aspect. Used to maintain SupportPlatform across the platform.
