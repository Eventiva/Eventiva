...
// get the TSX and JSX files from the project without using the built-in glob matcher of design-system-package
// to reduce the number of files DesignSystemPackage will try to scan
const content = globSync( [ '**/*.{jsx,tsx}' ], {
    ignore: [ '**/node_modules/**' ]
} )

/** @type {import('design-system-packagecss').Config} */
export const Preset = {
    content: [ ...content ]
}
