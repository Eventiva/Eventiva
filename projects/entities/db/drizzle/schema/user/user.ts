 ...
 * Project: Eventiva
 * File: user.ts
 * Last Modified: 04/09/2024, 23:08
 *
...
import { Base } from '@eventiva/entities.abstraction'
...
export const usersTable = Base.createTable
( usersTableName, {
...
export type UserPlain = typeof usersTable.$inferSelect;
